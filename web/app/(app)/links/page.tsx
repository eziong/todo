...
export default function LinksPage() {
  ...
  const { data: links, isLoading: linksLoading, error: linksError, refetch } = useLinks(filters)
  ...
  return (
    <LinksContent
      ...
      onProjectFilterChange={(projectId) => setFilters({ ...filters, projectId })}
      onCreateLink={(input: CreateLinkInput) => createLink.mutate(input)}
