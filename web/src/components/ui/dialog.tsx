    ...
    <DialogPortal data-slot="dialog-portal">
      ...
      <DialogPrimitive.Content
        ...
        className={cn(
          ...
          'shadow-[0_16px_48px_-12px_rgba(0,0,0,0.12),0_8px_16px_-8px_rgba(0,0,0,0.08)]',
          'dark:border dark:border-border/50 dark:shadow-[0_16px_48px_-12px_rgba(0,0,0,0.6),0_8px_16px_-8px_rgba(0,0,0,0.4)]',
          className,
        )}
        {...props}
      >
